...
public class EmployeeService {
    ...
    public List<EmployeeDTO> filter(String projectCode, String inputName, Pageable pageable) {
        if (inputName != null)
            inputName = "%" + inputName + "%";
        List<Employee> filterResults = employeeRepository.filter(projectCode, inputName, pageable);
